...
test("G: lib/report-v2-view.ts's resolveCompletionView (now exported) is unchanged in behavior — same defaults, same scope line, used by Report V2's own CompletionStrip", () => {
  ...
  assert.match(completed.scopeLine, /Compared against/, "Report V2's own scope line (with provider names) is untouched — the legacy notice deliberately does not reuse it, see slice-2 notes");
});
