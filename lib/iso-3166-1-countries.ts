// AUTO-CONTENT (hand-reviewed): ISO 3166-1 officially assigned country codes.
// Generated once from the ISO 3166-1 standard list; thereafter edited in place.
// Regenerate/verify with the structural assertions in
// tests/account-identity.test.mjs (unique alpha-2 / alpha-3 / numeric, exact
// format, spot checks). This is the CANONICAL residence-country reference for
// lib/account-identity.ts; it is a few KB of source, NOT one of the multi-MB
// city / ROR datasets that are deliberately kept out of the bundle.
//
// SCOPE: residence country only. Phone dial/region context is a SEPARATE
// concern handled by libphonenumber-js in lib/account-identity.ts and stored in
// its own column — never conflated with residence country_code.

export type IsoCountry = {
  /** ISO 3166-1 alpha-2 (uppercase). The canonical stored form. */
  readonly alpha2: string;
  /** ISO 3166-1 alpha-3 (uppercase). Accepted on input, normalized to alpha-2. */
  readonly alpha3: string;
  /** ISO 3166-1 numeric (3 digits, zero-padded). Informational. */
  readonly numeric: string;
  /** English short name (informational; not a display-localization source). */
  readonly name: string;
};

export const ISO_3166_1_COUNTRIES: readonly IsoCountry[] = Object.freeze([
  ...
  { alpha2: "AX", alpha3: "ALA", numeric: "248", name: "Aland Islands" },
  ...
  { alpha2: "BL", alpha3: "BLM", numeric: "652", name: "Saint Barthelemy" },
  ...
  { alpha2: "CI", alpha3: "CIV", numeric: "384", name: "Cote d'Ivoire" },
  ...
  { alpha2: "CW", alpha3: "CUW", numeric: "531", name: "Curacao" },
  ...
  { alpha2: "RE", alpha3: "REU", numeric: "638", name: "Reunion" },
  ...
  { alpha2: "TR", alpha3: "TUR", numeric: "792", name: "Turkiye" },
...
const BY_ALPHA2 = new Map(ISO_3166_1_COUNTRIES.map((c) => [c.alpha2, c]));
const BY_ALPHA3 = new Map(ISO_3166_1_COUNTRIES.map((c) => [c.alpha3, c]));

/** Look up a country by ISO 3166-1 alpha-2 (case-insensitive). */
export function isoCountryByAlpha2(code: string): IsoCountry | undefined {
  return typeof code === "string" ? BY_ALPHA2.get(code.trim().toUpperCase()) : undefined;
}

/** Look up a country by ISO 3166-1 alpha-3 (case-insensitive). */
export function isoCountryByAlpha3(code: string): IsoCountry | undefined {
  return typeof code === "string" ? BY_ALPHA3.get(code.trim().toUpperCase()) : undefined;
}
